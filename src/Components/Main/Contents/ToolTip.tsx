...
export default function ToolTip({
  ...
  const imageMediumHeight: number = 500;
  const imageMediumWidth: number = 400;

  const isRightSide = pointY * 1.58 + 11 > imageMediumWidth;
  const isBottomSide = pointX * 1.6 > imageMediumHeight;
